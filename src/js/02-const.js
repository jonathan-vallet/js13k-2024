...
const TILE_DATA = {
  ...
  characters: {
    ...
    colors: ['#000', skinColors[0], hairColors[0], outfitColors[0]],
    limit: 0,
  },
  spikes: {
  ...
  'sound-off': {
    rle: '16FMLBMeMLMfMBMCMDMgMAMYMAMYMANhMAMYMAMYNjMBMYMYMAMjMBM[MAMeYeYeYMCMYMBMYeYeYeMCMYMBM^MBM[MAM^MBMYMYMBN\\MAMYMAMYMCM[MAMYMAMYMDMZMBMCMFMYMLBMI',
    colors: COLOR_SETS.purple,
    limit: 0,
  },
  'sound-on': {
    rle: '16FMLBMeMLMfMBNGMgMAMfMDNhMBMfMBMjMCMfMAMjMDMeMAMeYeYeYMDMfNYeYeYeMDMfN^MDMeMAM^MCMfMBN\\MBMfMEM[MAMfMGMZMBNIMYMLBMI',
    colors: COLOR_SETS.green,
    limit: 0,
  },
};
